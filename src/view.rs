...
use crate::{editor::freelook::FreelookState, input_binding::InputBindingSystem, AppState};
...
fn gimbal_mouse_rotation(mut q_gimbal_changed: Query<(&Gimbal, &mut Transform), Changed<Gimbal>>) {
...
pub fn plugin(app: &mut App) {
    ...
    .add_systems(
        ...
        gimbal_mouse_rotation
            .run_if(in_state(AppState::InGame).or(in_state(FreelookState::Locked))),
    );
}
